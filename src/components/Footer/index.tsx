      ...
      <div className="contaniner-fluid footer">
        <div className="row gx-5 pt-3 mx-0">
          <div className="col-lg-4 col-md-12 footer__first-col">
            <br />
            <div className="footer__first-col__text d-flex justify-content-center text-white mt-4">
              {" "}
              SynerLink là một thương hiệu trà và đồ uống. Đây là mạng xã hội
              của chúng tôi
            </div>
            <div className="row mt-4 d-flex justify-content-center">
              <div className="col-2">
                <a href="#">
                  <img
                    src="/image/footer_facebook.svg"
                    className="footer__first-col__logo"
                  />
                </a>
              </div>
              <div className="col-2">
                <a href="#">
                  <img
                    src="/image/footer_twitter.svg"
                    className="footer__first-col__logo twitter"
                  />
                </a>
              </div>
              <div className="col-2">
              ...
              <div className="col-2">
                <a href="#">
                  <img
                    src="/image/footer_in.svg"
                    className="footer__first-col__logo in"
                  />
                </a>
              </div>
              <div className="col-2">
                <a href="#">
                  <img
                    src="/image/footer_instagram.svg"
                    className="footer__first-col__logo"
                  />
                </a>
              </div>
          ...
          <div className="col-lg-4 col-md-12 d-flex justify-content-center footer__first-col fifth_col text-white">
            <div>
              <div className="footer__title mt-5 pb-4">
                Liên Hệ Với Chúng Tôi
              </div>
              <div className="d-flex fifth_col__location">
                <img
                  src="/image/footer_location.svg"
                  className="mx-2"
              ...
              <div
                className="d-flex fifth_col__email"
          ...
          <div className="text-white text-center pb-4 pt-4 h6">
            Trang website SynerLink - © 2024
          </div>
        </div>
      </div>
    </footer>
