        ...
        <div className="container">
          <div className="row d-flex align-items-center pt-4">
            <div className="col-lg-6 col-md-12 px-3 title row d-flex align-items-center">
              <h5 className="col-lg-12 col-md-12 text-white title-title">
                Chào mừng bạn tới Indigo
              </h5>
              <div className="col-md-12 btn-top title"></div>
            </div>
          ...
          <div className="row d-flex refs-col">
            ...
            <div className="col-lg-6 header-refs">
              <div className="row text-center d-flex justify-content-center align-items-center">
                ...
                <h5 className="col">
                  <Link to="/about" className="header-ref">
                    Về Chúng Tôi
                  </Link>
                </h5>
                <h5 className="col">
                  <Link to="/projects" className="header-ref">
                    Sản Phẩm
                  </Link>
                </h5>
                <h5 className="col">
                  <Link to="/news" className="header-ref">
                    Tin tức
                  </Link>
                </h5>
                <h5 className="col">
                  <Link to="/contact" className="header-ref">
                    Liên hệ
                  </Link>
                </h5>
              </div>
        ...
        <div className="header-bg">
          <div className="container">
            <div
              ...
              className="header-bg-picture"
            >
              <h1 className="text-center text-white header-title">
                Sản Phẩm SynerLink Farm
              </h1>
            </div>
          </div>
        </div>
